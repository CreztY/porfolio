        ...
        <div className='contactCard'>
          ...
          <div className='socialLink'>
            ...
            <div className='socialLinks'>
              <a href='https://www.linkedin.com/in/ivan-cózar-ramos-a31b47102/' target='_blank' rel='noopener noreferrer'><LinkedIn />LinkedIn</a>
              <a href='https://github.com/CreztY' target='_blank' rel='noopener noreferrer'><Github />GitHub</a>
            </div>
          </div>
        </div>
      </div>
